...
BEGIN
  ...
  THEN
    ...
    -- This is the dispatch/restocking WhatsApp line. Keep the configured
    -- number in one place until a secure settings service replaces it.
    v_admin_phone := '7572866635';
